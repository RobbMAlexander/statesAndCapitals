...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Boolean doAllStatesHaveAnAnthem = states.stream().anyMatch((state) -> state.getStateAnthem() == "");
        ...
        Boolean doNoStatesHaveAOneWordMotto = states.stream().noneMatch((state) -> state.getStateMotto().contains(" "));
